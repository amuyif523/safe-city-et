...
- **Role portals** (`frontend/src/pages/*Portal.tsx`): Public, Police, Fire, Medical, Military, and Admin experiences with stats, tables, notifications, and React Leaflet maps.
